                ...
                width="400" height="100" version="1.1" viewBox="0 30 260 95" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                    <g>
                        ...
                        <g id="timer" transform="matrix(.56532 0 0 .66453 -19.003 -11.021)">
                            ...
                            <g id="timer-left">
                                <rect x="164.1" y="62.066" width="100" height="140"  fill={boardMotive.first} stroke="#292525" strokeWidth="5" />
                                ...
                                <g>
                                    ...
                                    <path id="gong-left"  className={assignClass(firstTeamData.name)} d="m189.5-152.26a19.242 22.186 0 0 1-18.931 22.183 19.242 22.186 0 0 1-19.542-21.466l19.232-0.71661z"  />
                                </g>
                                <g id="animationable-left" className={assignClass(firstTeamData.name)}>
                            ...
                            <g id="timer-right">
                                <rect x="264.1" y="62.066" width="100" height="140" fill={boardMotive.second} stroke="#292525" strokeWidth="5" />
                                ...
                                <g>
                                    ...
                                    <path id="gong-right" className={assignClass(secondTeamData.name)} d="m204.04 376.07a19.242 22.186 0 0 1-18.931 22.183 19.242 22.186 0 0 1-19.542-21.466l19.232-0.71661z" />
                                </g>
                                <g id="animationable-right" className={assignClass(secondTeamData.name)}>
